...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        profileForms.forEach(form => {
            // Only apply to the profile/security related forms
            const action = form.getAttribute('action');
            if (!action || (!action.includes('profile') && !action.includes('password') && !action.includes('security'))) return;
            if (form.id === 'deleteForm') return; // Skip delete form for now
