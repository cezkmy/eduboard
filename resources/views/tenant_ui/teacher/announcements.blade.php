<x-app-layout>
    <x-slot name="title">Announcements - EduBoard Teacher</x-slot>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="content-header flex items-center justify-between mb-8 gap-6">
            <div>
                <h1 class="content-title">Announcements</h1>
                <p class="content-subtitle">Stay updated with the latest school news</p>
            </div>
            ...
            @if(auth()->user()->hasPermission('page_teacher_edit_announcement'))
    ...
    <div class="mt-8">
        ...
        <div class="categories">
            @php
                ...
                $dynamicCategories = \App\Models\Category::where('type', 'announcement_category')->pluck('name')->toArray();
                $categories = array_merge(['All'], $dynamicCategories);
            @endphp
