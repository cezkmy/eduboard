<div class="profile-layout flex flex-col lg:flex-row gap-6 w-full">
    ...
    <div class="flex-1 min-w-0 space-y-6">
        <div class="profile-card p-6 bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col items-center text-center">
            ...
            <span class="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-teal-50 text-teal-600">Student</span>
        ...
        <div class="profile-card p-6 bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm">
            ...
            <form method="post" action="{{ route('tenant.profile.update') }}" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <input name="course" type="text" value="{{ old('course', $user->course) }}" class="w-full bg-gray-50 dark:bg-gray-700/50 border-none rounded-xl p-3 text-sm focus:ring-2 focus:ring-teal-500/20 transition-all">
                </div>

                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-1.5">
                        <label class="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Year Level</label>
                        <select name="year_level" class="w-full bg-gray-50 dark:bg-gray-700/50 border-none rounded-xl p-3 text-sm focus:ring-2 focus:ring-teal-500/20 transition-all appearance-none">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input name="section" type="text" value="{{ old('section', $user->section) }}" class="w-full bg-gray-50 dark:bg-gray-700/50 border-none rounded-xl p-3 text-sm focus:ring-2 focus:ring-teal-500/20 transition-all">
                    </div>
                </div>
