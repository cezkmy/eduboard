...
<head>
    ...
    <title>Trial Expired - {{ $school }}</title>
...
<body>
    <div class="card error-card p-5 text-center">
        ...
        <h2 class="fw-bold mb-3">Trial Expired</h2>
        <p class="text-secondary mb-4">
            The 1-month free trial for <strong>{{ $school }}</strong> has ended. 
            To continue using your school portal and managing your announcements, please subscribe to a plan.
        </p>
        <div class="d-grid gap-2">
            <a href="{{ config('app.central_url', 'http://eduboard.app:8000') }}/central/user/subscription" class="btn btn-edu">
                <i class="bi bi-credit-card me-2"></i>Upgrade to Continue
            </a>
